    ...
    return (
        <div className="sticker-selection" id="stickerSelection">
            <div className="sticker-icons">
                ...
                <DefaultSticker sticker={{ type: 'image', imageURL: 'https://via.placeholder.com/150', width: 150, height: 150 }} />
            ...
            <div className="featured-stickers">
                ...
                <PreviewSticker sticker={{ type: 'image', imageURL: 'https://via.placeholder.com/150', width: 150, height: 150 }} />
